export const ptBR = {
  ...
  admin: {
    ...
    users: {
      ...
      activationTitle: 'Link de ativação',
      recoveryTitle:   'Redefinição de senha',
      recoveryEmailSent: 'E-mail de redefinição de senha enviado para',
      recoveryLinkLabel: 'Copie e envie o link de redefinição ao usuário:',
